...
import { Gift, X, PartyPopper, Sparkles, CalendarOff } from "lucide-react";
    ...
    return (
        <>
            ...
            <button
                ...
                title={hasBirthdays ? "Upcoming Birthdays" : "No upcoming birthdays"}
            >
                <div className="relative">
                    {hasToday ? (
                        ...
                        <Gift className={`w-6 h-6 group-hover:rotate-12 transition-transform ${hasBirthdays ? "text-[#FF007A]" : "text-white/40"}`} />
                    )}
                </div>

                {/* Badge - show count or nothing */}
                {hasBirthdays && (
                    ...
                    >
                        ...
                        <div className="relative p-6 pt-8 pb-4 text-center z-10 border-b border-white/5">
                            ...
                            <p className="text-[#A800FF] text-[10px] mt-2 uppercase tracking-[0.3em] font-bold">
                                {hasBirthdays ? "Upcoming Celebrations" : "Next 7 Days"}
                            </p>
                        </div>
                        ...
                        <div className="max-h-[55vh] overflow-y-auto px-4 py-4 scrollbar-hide relative z-10">
                            {loading ? (
                                <div className="text-center py-12">
                                    ...
                                    <p className="text-white/40 text-sm">Checking birthdays...</p>
                                </div>
                            ) : hasBirthdays ? (
                                ...
                                <div className="text-center py-12">
                                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white/5 border border-white/5 mb-4">
                                        <CalendarOff className="w-8 h-8 text-white/20" />
                                    </div>
                                    <p className="text-white/50 text-sm font-medium">No upcoming birthdays</p>
                                    <p className="text-white/25 text-xs mt-1">in the next 7 days</p>
                                </div>
                            )}
                        </div>
